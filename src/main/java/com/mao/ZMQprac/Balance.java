        ...
        new Thread(new Runnable(){
            ...
            public void run() {
                ...
                while (!Thread.currentThread().isInterrupted()) {
                    ...
                    ZFrame frame = new ZFrame(name.getBytes());
...
class Middle {
    ...
    Logger l = Logger.getLogger(Middle.class.getName());
    public Middle() {
...
//            l.info("end poll");
            ...
            System.out.println("worker ready:" + this.workers.size() + "  requests:" + this.requests.size());
...
public class Balance {
    ...
    public static void main(String args[]) {
        Worker worker = new Worker("mao", 500);
        worker.start();
        Worker worker2 = new Worker("liu", 2000);
        worker2.start();
